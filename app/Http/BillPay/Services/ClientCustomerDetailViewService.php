...
use App\Http\BillPay\Repositories\ClientCustomerDetailViewRepo;
...
class ClientCustomerDetailViewService implements IFindOneByService,
                                            IFindByIdService, IFindAllService
{

    private $repository;
    public function __construct(ClientCustomerDetailViewRepo $repository)
    {
