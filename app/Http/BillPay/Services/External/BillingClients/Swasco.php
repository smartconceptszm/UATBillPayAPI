...
class Swasco implements IBillingClient
{
    ...
    private $swascoReceiptingTimeout;
    private $swascoTimeout;
    private $baseURL;
    ...
    public function __construct(
            int $swascoReceiptingTimeout,
            int $swascoTimeout,
            string $baseURL
        )
    {
        $this->swascoReceiptingTimeout = $swascoReceiptingTimeout;
        $this->swascoTimeout = $swascoTimeout;
