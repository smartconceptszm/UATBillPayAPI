...
class Lukanga implements IBillingClient
{
    ...
    public function __construct(XMLtoArrayParser $xmlToArrayParser,
        LukangaSoapService $lukangaSoapService,
        string $soapUserName, 
        string $soapPassword,
        string $soapToken, 
        string $operator,
    ...
    {
        $this->lukangaSoapService=$lukangaSoapService;
        $this->xmlToArrayParser=$xmlToArrayParser;
