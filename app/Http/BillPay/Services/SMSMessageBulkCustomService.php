...
use App\Http\BillPay\Repositories\BulkSMSOfClientRepo;
use App\Http\BillPay\Repositories\BulkMessageRepo;
use Illuminate\Support\Facades\Auth;
use App\Http\BillPay\DTOs\SMSTxDTO;
use App\Jobs\BulkSMSJob;
use Exception;

class SMSMessageBulkCustomService implements ICreateService, IFindByIdService, IFindAllService
{
   ...
   {
      try {
         return $this->bulkSMSOfClientRepo->findAll($criteria);
      } catch (\Throwable $e) {
