...
namespace App\Http\Services\External\BillingClients\Nkana;
...
class PurchaseEncryptor{
   ...
   public function __construct(){
      $this->rootkeystr = \env('NKANA_PREPAID_ROOTKEY');
   }
   ...
   */
   public function generatePurchaseString($transactionId, $paymentAmount){
