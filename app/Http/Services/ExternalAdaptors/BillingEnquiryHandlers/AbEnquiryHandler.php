...
abstract class AbEnquiryHandler  implements IEnquiryHandler
{
   ...
   public function __construct(
	...
	public function handle(BaseDTO $txDTO):BaseDTO
	{
		...
		try {
			...
			if(!$txDTO->customer){
            $txDTO = $this->getAccountDetails($txDTO);
   ...
   protected abstract function getAccountDetails(BaseDTO $txDTO):BaseDTO;
