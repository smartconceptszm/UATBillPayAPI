...
class ClientWalletService
{
   ...
   public function getWalletsOfClient(string $client_id):array|null
   {
      try {
         $records = DB::table('client_wallets as cw')
                  ...
                  ->select('cw.*','pp.shortName','pp.name', 'c.shortName as client','c.name as clientName')
