...
class InitiateCardAPIPaymentService implements IInitiateAPIPayment
{
   ...
   public function handle(array $params): array{
      ...
      try {
         ...
         $paymentDTO = $this->cardDTO->fromArray(\get_object_vars($thePayment));
         ...
         Log::info('('.$paymentDTO->urlPrefix.') '.
                        'Card API payment initiated: Wallet: '.
