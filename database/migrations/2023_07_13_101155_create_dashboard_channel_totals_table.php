...
return new class extends Migration
{
   ...
   {
      Schema::create('dashboard_channel_totals', function (Blueprint $table) {
         $table->id();
         $table->string('client_id',36)->notNullable();
         $table->string('channel',150)->notNullable();
         ...
         $table->timestamps();
         $table->unique(['client_id','channel','dateOfTransaction'],'client_channel_day');
      });
   }
   ...
   {
      Schema::dropIfExists('dashboard_consumer_type_totals');
   }
};
