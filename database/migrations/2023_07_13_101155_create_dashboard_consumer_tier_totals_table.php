...
return new class extends Migration
{
   ...
   public function up(): void
   {
      ...
      Schema::create('dashboard_consumer_tier_totals', function (Blueprint $table) {
         $table->id();
         ...
         $table->timestamps();
         $table->unique(['client_id','consumerTier','dateOfTransaction'],'client_consumer_tier_day');
      });
   ...
   {
      Schema::dropIfExists('dashboard_consumer_tier_totals');
   }
};
